# -*- coding: utf-8 -*-
#
# Date Calculator documentation build configuration file, created by
...
project = u'Date Calculator'
copyright = u'2016-2021, Chris Warrick'
...
htmlhelp_basename = 'Date Calculatordoc'
...
latex_documents = [
  ('index', 'datecalc.tex', u'Date Calculator Documentation',
...
man_pages = [
    ('index', 'datecalc', u'Date Calculator Documentation',
     [u'Chris Warrick'], 1)
]
